...
def main():
    ...
    with tempfile.TemporaryDirectory() as submission_dir:
        ...
        ingestion_command = "python {} {} {} {}".format(ingestion_program, submission_dir, args.games_dir, ingestion_out)
        if args.debug:
        ...
        try:
            ...
            score_command = "python {} {} {}".format(score_program, ingestion_out, score_out)
